...
public class PieceOne : MonoBehaviour
{
    public GameBoardOne boardOne { get; private set; }
    ...
    public void Initialize(GameBoardOne boardOne, Vector3Int position, TetrominoData data)
    {
    ...
    private void Update()
    {
        ...
        {
            this.boardOne.Clear(this); //clears piece from the board
            ...
            this.boardOne.Set(this); //sets piece in the board
        }
    }
    ...
    private void Lock()
    {
        this.boardOne.Set(this);
        this.boardOne.ClearLines();
        this.boardOne.SpawnPiece();
    }
    ...
    private bool Move(Vector2Int translation)//make sure movement is valid, Gameboard will allow you to measure correctly
    {
        ...
        bool valid = boardOne.IsValidPosition(this, newPosition);
        if (valid)
        {
