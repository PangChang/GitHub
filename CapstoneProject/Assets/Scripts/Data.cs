...
public static class Data //can access this data from everywhere
{
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[]> Cells = new Dictionary<Tetromino, Vector2Int[]>() //dictionary of my shapes
    {
